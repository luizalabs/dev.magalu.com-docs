...
Utilizando o tenant certo, você está pronto para explorar outras partes da API. Para utilizar qualquer um desses tenants você deve passar o `uuid` do tenant no header `X-Tenant-ID`. Por exemplo:
