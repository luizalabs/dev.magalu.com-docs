...
Após o usuário ser redirecionado para a nossa URL de autenticação, ele cairá em uma tela de login, que permitirá que ele faça login como vendedor ou consumidor. É esperado que o usuário, nesse momento, preencha os seus dados e faça o login, e então inicia-se o passo 3.
